# Chris Whalen — Case Study #3 Context

> **How to use this file:** Paste this entire document as the first message in a new Claude conversation. This file is specifically scoped to **Case Study #3: "The Perfect Storm"** — reading a cultural moment and building the theatrical giveaway playbook at Angel. The other three cases are referenced as locked, but their full text is not included here. If you need to reference Case #1, #2, or #4 in detail, paste in the corresponding case context file or ask Chris.
>
> **This file's job:** Be the working context for any update, refinement, or extension of Case Study #3.
...
## Other cases (locked, summary only — see other context files for full text)

- **Case #1: "Communication is King"** — Building the design function at Angel. Locked. Closing beat: how I lead.
- **Case #2: "Pay It Forward"** — Shipping a revenue-generating product surface while leading the design function. Locked. Closing beat: when to step back.
- **Case #4: "The Discipline of Calling It"** — Founding, running, and winding down Historik. Locked. Closing beat: the discipline of calling it.

Do NOT re-litigate any of those three in this conversation. They are locked. If Chris wants to update one of them, he'll switch to that case's context file.
...
**Refine, update, or extend Case Study #3: "The Perfect Storm."**

Common reasons Chris will open this chat:
- Updating the case after a new theatrical giveaway runs the playbook
- Adding new outcomes from future giveaways that prove (or disprove) the model
- Tightening language for the site build
- Cross-referencing the case against Case #1, #2, or #4 for consistency

**Voice and structure preservation:** The case is finalized in the form below. The other three cases match its structural template (nine sections). Do not restructure unilaterally. If a structural change is proposed, it has to apply across all four cases — flag that to Chris before making it.

**Read the case below in full before suggesting any edit.** The nuance is in the specific language, not the outline.

---

# CASE STUDY #3: "The Perfect Storm" (FINALIZED)
